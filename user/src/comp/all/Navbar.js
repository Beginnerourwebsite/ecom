  ...
  return (
    <div>
            ...
            <div class="offcanvas__content">
              <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                <div class="offcanvas__logo logo">
                  <a href="index.html">
                    <img src="ajay/img/logo/logo.svg" alt="logo" />
                  </a>
                </div>
              </div>
              ...
              <div class="offcanvas__contact align-items-center d-none">
                <div class="offcanvas__contact-icon mr-20">
                  <span>
                    <img src="ajay/img/icon/contact.png" alt="" />
                  </span>
                </div>
                ...
                <div class="offcanvas__select language">
                  <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                    <div class="offcanvas__lang-img mr-15">
                      <img src="ajay/img/icon/language-flag.png" alt="" />
                    </div>
      ...
      <div class="cartmini__wrapper d-flex justify-content-between flex-column">
        <div class="cartmini__top-wrapper">
            ...
            <div class="cartmini__widget-item">
              <div class="cartmini__thumb">
                <a href="product-details.html">
                  <img src="ajay/img/product/product-1.jpg" alt="" />
                </a>
              </div>
          ...
          <div class="cartmini__empty text-center d-none">
            <img src="ajay/img/product/cartmini/empty-cart.png" alt="" />
                      ...
                      <div class="tp-header-category tp-category-menu tp-header-category-toggle">
                        ...
                        <li class="has-dropdown">
                          ...
                          <ul class="mega-menu tp-submenu">
                            <li>
                              <a href="shop.html" class="mega-menu-title"
                                >Featured</a
                              >
                              <ul>
                                <li>
                                  <a href="shop.html"
                                    ><img
                                      src="ajay/img/header/menu/menu-1.jpg"
                                      alt=""
                                  /></a>
                                </li>
                                <li>
                            ...
                            <li>
                              ...
                              <ul>
                                <li>
                                  <a href="shop.html"
                                    ><img
                                      src="ajay/img/header/menu/menu-2.jpg"
                                      alt=""
                                  /></a>
                                </li>
                                <li>
                            ...
                            <li>
                              ...
                              <ul>
                                <li>
                                  <a href="shop.html"
                                    ><img
                                      src="ajay/img/header/menu/menu-3.jpg"
                                      alt=""
                                  /></a>
                                </li>
                                <li>
                                    ...
                                    <div class="home-menu-item">
                                      <a href="index.html">
                                        <div class="home-menu-thumb p-relative fix">
                                          <img
                                            src="ajay/img/menu/menu-home-1.jpg"
                                            alt=""
                                          />
                                        </div>
                                  ...
                                  <div class="col">
                                    <div class="home-menu-item">
                                      <a href="index-2.html">
                                        <div class="home-menu-thumb p-relative fix">
                                          <img
                                            src="ajay/img/menu/menu-home-2.jpg"
                                            alt=""
                                          />
                                        </div>
                                        <div class="home-menu-content">
                                  ...
                                  <div class="col">
                                    <div class="home-menu-item">
                                      <a href="index-3.html">
                                        <div class="home-menu-thumb p-relative fix">
                                          <img
                                            src="ajay/img/menu/menu-home-3.jpg"
                                            alt=""
                                          />
                                        </div>
                                        <div class="home-menu-content">
                                  ...
                                  <div class="col">
                                    <div class="home-menu-item">
                                      <a href="index-4.html">
                                        <div class="home-menu-thumb p-relative fix">
                                          <img
                                            src="ajay/img/menu/menu-home-4.jpg"
                                            alt=""
                                          />
                                        </div>
                                        <div class="home-menu-content">
                                  ...
                                  <div class="col">
                                    <div class="home-menu-item">
                                      <a href="index-5.html">
                                        <div class="home-menu-thumb p-relative fix">
                                          <img
                                            src="ajay/img/menu/menu-home-5.jpg"
                                            alt=""
                                          />
                                        </div>
                                        <div class="home-menu-content">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3">
                                <div class="shop-mega-menu-img">
                                  <img
                                    src="ajay/img/menu/product/menu-product-img-1.jpg"
                                    alt=""
                                  />
                              ...
                              <div class="col-lg-3">
                                <div class="shop-mega-menu-img">
                                  <img
                                    src="ajay/img/menu/product/menu-product-img-2.jpg"
                                    alt=""
                                  />
                                  <div class="shop-mega-menu-btn">
                                    <a
      ...
      <div className="tp-header-area tp-header-style-primary tp-header-height">
        <div id="header-sticky" className="tp-header-bottom-1 tp-header-sticky">
            ...
            <div className="tp-mega-menu-wrapper p-relative">
              <div className="row align-items-center">
                <div className="col-xl-2 col-lg-5 col-md-5 col-sm-4 col-6">
                  <div className="logo">
                    <a href="index.html">
                      <img src="Elite.png" alt="logo" width={"50px"} height={"50px"}/>
                    </a>
                  </div>
                </div>
                ...
                <div className="col-xl-5 col-lg-7 col-md-7 col-sm-8 col-6">
                  <div className="tp-header-bottom-right d-flex align-items-center justify-content-end pl-30">
                      ...
                      <form action="#">
                        ...
                        <button type="submit">
                          <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M18.9999 19L14.6499 14.65" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                    ...
                    <div class="tp-header-action-item">
                      <Link to='/cart' title='Cart' class="tp-header-action-btn cartmini-open-btn" >
                        ...
                        <span class="tp-header-action-badge">{sessionStorage.getItem("carts")}</span>
                      </Link>
                    </div>
                    <div class="tp-header-action-item">
                      <button title='Log out' class="tp-header-action-btn cartmini-open-btn" >
