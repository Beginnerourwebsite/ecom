            ...
            <div className="media static-top-widget align-items-center">
              <div className="icons-widgets">
                <div className="align-self-center text-center">
                  <i data-feather="navigation" className="font-warning" />
                </div>
              </div>
        ...
        <div className="card o-hidden widget-cards">
          <div className="secondary-box card-body">
            <div className="media static-top-widget align-items-center">
              <div className="icons-widgets">
                <div className="align-self-center text-center">
                  <i data-feather="box" className="font-secondary" />
                </div>
              </div>
              <div className="media-body media-doller">
      ...
      <div className="col-xxl-3 col-md-6 xl-50">
        <div className="card o-hidden widget-cards">
          <div className="primary-box card-body">
            <div className="media static-top-widget align-items-center">
              <div className="icons-widgets">
                <div className="align-self-center text-center"><i data-feather="message-square" className="font-primary" /></div>
              </div>
      ...
      <div className="col-xxl-3 col-md-6 xl-50">
        <div className="card o-hidden widget-cards">
          <div className="danger-box card-body">
            <div className="media static-top-widget align-items-center">
              <div className="icons-widgets">
                <div className="align-self-center text-center"><i data-feather="users" className="font-danger" /></div>
              </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="user-status table-responsive latest-order-table">
              ...
              <a href="order.html" className="btn btn-primary mt-4">View All Orders</a>
            </div>
            <div className="code-box-copy">
              <button className="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-head1" title data-original-title="Copy"><i className="icofont icofont-copy-alt" /></button>
              <pre className=" language-html"><code className=" language-html" id="example-head1">{"\n"}&lt;div class="user-status table-responsive latest-order-table"&gt;{"\n"}{"    "}&lt;table class="table table-bordernone"&gt;{"\n"}{"        "}&lt;thead&gt;{"\n"}{"            "}&lt;tr&gt;{"\n"}{"                "}&lt;th scope="col"&gt;Order ID&lt;/th&gt;{"\n"}{"                "}&lt;th scope="col"&gt;Order Total&lt;/th&gt;{"\n"}{"                "}&lt;th scope="col"&gt;Payment Method&lt;/th&gt;{"\n"}{"                "}&lt;th scope="col"&gt;Status&lt;/th&gt;{"\n"}{"            "}&lt;/tr&gt;{"\n"}{"        "}&lt;/thead&gt;{"\n"}{"        "}&lt;tbody&gt;{"\n"}{"            "}&lt;tr&gt;{"\n"}{"                "}&lt;td&gt;1&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;$120.00&lt;/td&gt;{"\n"}{"                "}&lt;td class="font-secondary"&gt;Bank Transfers&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;Delivered&lt;/td&gt;{"\n"}{"            "}&lt;/tr&gt;{"\n"}{"            "}&lt;tr&gt;{"\n"}{"                "}&lt;td&gt;2&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;$90.00&lt;/td&gt;{"\n"}{"                "}&lt;td class="font-secondary"&gt;Ewallets&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;Delivered&lt;/td&gt;{"\n"}{"            "}&lt;/tr&gt;{"\n"}{"            "}&lt;tr&gt;{"\n"}{"                "}&lt;td&gt;3&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;$240.00&lt;/td&gt;{"\n"}{"                "}&lt;td class="font-secondary"&gt;Cash&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;Delivered&lt;/td&gt;{"\n"}{"            "}&lt;/tr&gt;{"\n"}{"            "}&lt;tr&gt;{"\n"}{"                "}&lt;td&gt;4&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;$120.00&lt;/td&gt;{"\n"}{"                "}&lt;td class="font-primary"&gt;Direct Deposit&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;Delivered&lt;/td&gt;{"\n"}{"            "}&lt;/tr&gt;{"\n"}{"            "}&lt;tr&gt;{"\n"}{"                "}&lt;td&gt;5&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;$50.00&lt;/td&gt;{"\n"}{"                "}&lt;td class="font-primary"&gt;Bank Transfers&lt;/td&gt;{"\n"}{"                "}&lt;td class="digits"&gt;Delivered&lt;/td&gt;{"\n"}{"            "}&lt;/tr&gt;{"\n"}{"        "}&lt;/tbody&gt;{"\n"}{"    "}&lt;/table&gt;{"\n"}&lt;/div&gt;{"\n"}{"                                    "}</code></pre>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm-12">
        <div className="card">
          ...
          <div className="card-body sell-graph">
            <canvas id="myGraph" />
            <div className="code-box-copy">
              <button className="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-head3" title data-original-title="Copy"><i className="icofont icofont-copy-alt" /></button>
              <pre className=" language-html"><code className=" language-html" id="example-head3">&lt;div class="card-body sell-graph"&gt;{"\n"}{"   "}&lt;canvas id="myGraph"&gt;&lt;/canvas&gt;{"\n"}&lt;/div&gt;</code></pre>
            </div>
          </div>
        </div>
      </div>
                ...
                <tbody>
                  <tr>
                    <td className="bd-t-none u-s-tb">
                      <div className="align-middle image-sm-size"><img className="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="assets/images/dashboard/user2.jpg" alt data-original-title title />
                        <div className="d-inline-block">
                          <h6 className="mb-0">John Deo <span className="text-muted digits">(14+
                              Online)</span></h6>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td className="bd-t-none u-s-tb">
                      <div className="align-middle image-sm-size"><img className="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="assets/images/dashboard/user1.jpg" alt data-original-title title />
                        <div className="d-inline-block">
                          <h6 className="mb-0">Holio Mako <span className="text-muted digits">(250+ Online)</span>
                          </h6>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="progress-showcase">
                        <div className="progress" style={{height: 8}}>
                          <div className="progress-bar bg-secondary" role="progressbar" style={{width: '70%'}} aria-valuenow={50} aria-valuemin={0} aria-valuemax={100} />
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td className="bd-t-none u-s-tb">
                      <div className="align-middle image-sm-size"><img className="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="assets/images/dashboard/user3.jpg" alt data-original-title title />
                        <div className="d-inline-block">
                          <h6 className="mb-0">Mohsib lara<span className="text-muted digits">(99+ Online)</span>
                          </h6>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="progress-showcase">
                        <div className="progress" style={{height: 8}}>
                          <div className="progress-bar bg-primary" role="progressbar" style={{width: '60%'}} aria-valuenow={50} aria-valuemin={0} aria-valuemax={100} />
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td className="bd-t-none u-s-tb">
                      <div className="align-middle image-sm-size"><img className="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="assets/images/dashboard/user.jpg" alt data-original-title title />
                        <div className="d-inline-block">
                          <h6 className="mb-0">Hileri Soli <span className="text-muted digits">(150+ Online)</span>
                          </h6>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td className="bd-t-none u-s-tb">
                      <div className="align-middle image-sm-size"><img className="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="assets/images/dashboard/designer.jpg" alt data-original-title title />
                        <div className="d-inline-block">
                          <h6 className="mb-0">Pusiz bia <span className="text-muted digits">(14+ Online)</span>
                          </h6>
                        </div>
                      </div>
                    </td>
                ...
                <div className="order-graph sm-order-space">
                  ...
                  <div className="order-graph-bottom sales-location">
                    <div className="media">
                      ...
                      <div className="media-body">
                        <h6 className="mb-0 me-0">Germany <span className="pull-right">25%</span></h6>
                      </div>
                    </div>
                    <div className="media">
                      <div className="order-shape-secondary" />
                      <div className="media-body">
                        <h6 className="mb-0 me-0">Brasil <span className="pull-right">10%</span></h6>
                      </div>
                    </div>
                    <div className="media">
                      <div className="order-shape-danger" />
                      <div className="media-body">
                        <h6 className="mb-0 me-0">United Kingdom<span className="pull-right">34%</span></h6>
                      </div>
                    </div>
                    <div className="media">
                      <div className="order-shape-warning" />
                      <div className="media-body">
                        <h6 className="mb-0 me-0">Australia<span className="pull-right">5%</span></h6>
                      </div>
                    </div>
                    <div className="media">
                      <div className="order-shape-success" />
                      <div className="media-body">
                        <h6 className="mb-0 me-0">Canada <span className="pull-right">25%</span></h6>
                      </div>
                    </div>
                  </div>
                </div>
